...
@section('contenido')
    <div class="flex items-center gap-2.5">
        ...
        <x-ayuda
            titulo="Edificio"
            que="El catálogo de oficinas del edificio. Es lo que la puerta ofrece al elegir a qué piso va un invitado."
            :pasos="[
    ...
    <p class="mt-1 text-sm text-slate-500">El catálogo de oficinas que la puerta ofrece al marcar el piso de un invitado.</p>
