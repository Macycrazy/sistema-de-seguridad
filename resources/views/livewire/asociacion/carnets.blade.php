<div class="max-w-2xl">
{{-- El interruptor del escáner vivía aquí; ahora está junto a los otros dos, porque la
     pregunta «¿qué se le ofrece al vigilante?» se responde mejor en un solo sitio. --}}
<p class="mb-5 rounded border border-slate-200 bg-white px-4 py-3 text-sm text-slate-600">
    Para encender o apagar «Escanear carnet» en la puerta:
